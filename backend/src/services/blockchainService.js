...
import { provider, wallet as adminWallet, BLOCKCHAIN_PRIVATE_KEY, electionContract as electionFactoryContract, votingContract } from "../blockchain/index.js";
...
export function getUserWallet(userId) {
    ...
    // Derive a unique private key by hashing the admin private key with the user's ID
    const userPrivateKey = ethers.keccak256(ethers.toUtf8Bytes(BLOCKCHAIN_PRIVATE_KEY + userId));
