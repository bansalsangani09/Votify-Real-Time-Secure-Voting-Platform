...
const CreateElectionWizard = ({ isOpen, onClose }) => {
    ...
    const handlePublish = async () => {
        ...
        try {
            ...
            const combinedStart = new Date(`${formData.startDate}T${formData.startTime}`).toISOString();
            const combinedEnd = new Date(`${formData.endDate}T${formData.endTime}`).toISOString();
